...
function CheckQuest() 
    ...
    if World1 then
        ...
        elseif MyLevel == 10 or MyLevel <= 14 or _G.Select_Mob_Farm == "Monkey [Lv. 14]" then -- Monkey
			...
			SPAWNPOINT = "Jungle"
		elseif MyLevel == 15 or MyLevel <= 90 or _G.Select_Mob_Farm == "Shanda [Lv. 475]" then -- Shandas
            sky = false
			Ms = "Shanda [Lv. 475]"
...
--------------------------------------------------------------------
local Library = Update:Window("An Hub  ","")
------------------------------------------
...
Setting:Button("Copy Discord Link",function()
 ...
 setclipboard("https://discord.gg/CtjfhGESW9")
 end)
